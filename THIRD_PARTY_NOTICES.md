...
| PaddleOCR / PP-OCRv6 small-det + medium-rec | 文字检测、识别模型与字符字典；实际 ONNX 制品取自 GreatV/oar-ocr v0.7.0 Release | Apache License 2.0 | [PaddleOCR 上游](https://github.com/PaddlePaddle/PaddleOCR) / [构建所用制品](https://github.com/GreatV/oar-ocr/releases/tag/v0.7.0) |
...
各项目的商标和模型归其权利人所有。完整发布包应保留本文件，以及 OAR OCR、ort、PaddleOCR/模型和 ONNX Runtime 对应的许可证与版权声明；上游链接用于核对来源和版本。rshot 项目自身的开源许可证尚未声明，应由项目所有者确定后补充根级 `LICENSE`、Cargo 元数据及后续发布包。
